-- это пример базы данных, на которой я
-- тестировала свои решения
-- и изменяла её в соответствии с заданиями
...
VALUES
    ...
    (10, 'Johnson', 'John', 'Krasnodar', '1998-04-04'),
    (5, 'Vasiliev', 'Vasiliy', 'Moscow', '2000-05-05');


INSERT INTO Book (ISBN, Title, Author, PagesNum, PubYear, PubName)
VALUES
    ('978-1234567890', 'Mount Everest1', 'Mark Twain', 200, 2000, 'Science Pub'),
    ('978-1234567891', 'Mount Everest2', 'John Smith', 200, 1990, 'Science Pub'),
    ('978-1234567892', 'Mount Everest3', 'John Smith', 200, 1010, 'Science Pub'),
    ('978-1234567893', 'Mount Everest4', 'John Smith', 200000, 2010, 'Science Pub'),
    ('978-1234567894', 'Mount Everest5', 'John Smith', 200, 2010, 'Science Pub'),
    ('978-1234567895', 'Mount Everest', 'John Smith', 200, 2010, 'Science Pub'),
    ...
    ('123456', 'Python Programming', 'Ivan Ivanov', 400, 2018, 'Reference Books'),
    ('12345678', 'Python Programming', 'Ivan Ivanov', 400, 2018, 'Reference Books'),
...
VALUES
    ...
    (1, '978-2345678901', 1, '2023-02-01'),
    (2, '978-3456789012', 1, null),
    (3, '978-4567890123', 1, '2022-04-01'),
    (1, '12345678', 1, '2023-04-01'),
